console.info("Price King Birds and Bees Catalogue Build: 15.0");
...
const ROLES = {
  admin: {
    label: "Administrator",
    sections: ["overview", "alcohol", "countsets", "stock", "history", "audit"],
    writeInventory: true
  },
  alcohol_manager: {
    label: "Alcohol Manager",
    sections: ["overview", "alcohol", "countsets", "stock", "history"],
    writeInventory: true
  },
  alcohol_viewer: {
...
function canUseSection(section) {
  ...
  if (entryMode === "alcohol") return ["overview", "alcohol", "countsets", "stock", "history"].includes(section);
  return true;
}
