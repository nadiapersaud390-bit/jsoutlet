console.info("Price King Easy Login Build: 2.0");
...
const ROLES = {
  admin: {
    label: "Administrator",
    sections: ["overview", "alcohol", "history", "audit"],
    writeInventory: true
  },
  alcohol_manager: {
  ...
  target.innerHTML = `
    <section class="hero-card card">
      <div>
        ...
        <h1>Welcome, ${escapeHtml(state.profile.displayName || profile.loginName || "User")}.</h1>
